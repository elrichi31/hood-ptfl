...
import { classifyPending, linkStories } from '#services/news'
...
export default class NewsClassify extends BaseCommand {
  ...
  static description = 'Classify + story-link pending news articles with TypeSafe (needs TYPESAFE_API_KEY)'
